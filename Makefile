...
GLOBAL_CONFIG := settings.json claude.json mcp-servers.json container-CLAUDE.md allowed-domains.txt browser-domains.txt skip-decryption.txt muted-hosts.txt .gitconfig .gitignore_global .env
...
test-resource-limits:
	bats test/resource-limits.bats
