...
- [Publishing to ghcr.io](docs/publishing-ghcr.md) — reuse a published base image instead of building it from source (`CLAUDE_DOCKER_BASE_IMAGE`), or build fully from source as before
